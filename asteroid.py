...
Frame_Rate_In_Milliseconds = 119    #Speed of screen updates
...
while True:
    ...
    if  (ship_X == asteroid_x) and (asteroid_y == 4):
        display_game_over(ship_X , score)
        break  #Test to see if the ship has hit an asteroid
        # STEP 1 ##########################################################
